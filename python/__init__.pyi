...
def compile(
    pattern: Regexp[AnyStr] | AnyStr, options: Options | None = None
) -> Regexp[AnyStr]: ...
def search(
...
class Regexp(Generic[AnyStr]):
    ...
    def subn(
        self,
        repl: _AnyStr2 | Callable[[Match[_AnyStr2]], _AnyStr2],
        text: _AnyStr2,
        count: int = 0,
    ) -> tuple[_AnyStr2, int]: ...
    def sub(
...
class Match(Generic[AnyStr]):
    def expand(self: Match[AnyStr], template: str) -> AnyStr: ...
    ...
    @overload
    def groupdict(self: Match[AnyStr]) -> dict[AnyStr, AnyStr]: ...
    @overload
...
class Filter:
    ...
    def re(self, index: int) -> Regexp[AnyStr]: ...
